...
privileged aspect VerificatorDataOnDemand_Roo_DataOnDemand {
    ...
    @Autowired
    ApplicationStateDataOnDemand VerificatorDataOnDemand.applicationStateDataOnDemand;
    
    public Verificator VerificatorDataOnDemand.getNewTransientVerificator(int index) {
        Verificator obj = new Verificator();
        setApplicationState(obj, index);
        setCause(obj, index);
    ...
    public void VerificatorDataOnDemand.setApplicationState(Verificator obj, int index) {
        ApplicationState applicationState = applicationStateDataOnDemand.getRandomApplicationState();
        obj.setApplicationState(applicationState);
    }
