...
public class DatasourceVerificatorTest extends AbstractJUnit4SpringContextTests {
    ...
    public void setUp() throws IllegalStateException, NamingException {
        ...
        builder.bind("java:comp/env/jdbc/mydatasource", this.dataSource);
        builder.activate();
    }
    ...
    public void testExecuteParamsEmpty() {
        this.verificator = new DatasourceVerificator(null);
    ...
    public void testExecuteParamsDatasourceNoExists() {
        ...
        this.verificator = new DatasourceVerificator(params);
        final VerificatorResult result = this.verificator.execute();
        Assert.assertNotNull(result);
        Assert.assertFalse(result.isSuccess());
    }
